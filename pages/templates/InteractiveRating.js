    ...
    <React.Fragment>
      ...
      <section className="bg-black p-0 lg:p-10 md:p-10">
        <section className="h-screen flex">
          {submitState ? (
            <section className="p-7 w-11/12 md:w-7/12 lg:w-3/12 m-auto bg-gray-900 text-white rounded-xl shadow-xl text-center">
              <svg
            ...
            <section className="p-7 w-11/12 md:w-7/12 lg:w-3/12 m-auto bg-gray-900 text-white rounded-xl shadow-xl">
              <svg
