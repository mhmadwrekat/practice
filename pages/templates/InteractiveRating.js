...
const InteractiveRating = () => {
  ...
  const rating_check = (item) => {
    setRate(item);
  };
  const submit_rating = () => {
    rate > 0 && setSubmitState(true)
  };
  ...
  return (
    <section className="">
      ...
      <section className="h-screen flex bg-black">
        {submitState ? (
          <section
            className="p-7 w-11/12 md:w-7/12 lg:w-3/12 m-auto bg-gray-900 text-white rounded-xl shadow-xl text-center"
          >
            <svg
            ...
            <p className="my-4 bg-gray-800 rounded-full inline-block px-5 py-1 text-orange-500">
              You selected {rate} out of {rateStarNumber.length}
            </p>
            <p className="my-5 text-3xl font-semibold">Thank you!</p>
          ...
          <section
            className="p-7 w-11/12 md:w-7/12 lg:w-3/12 m-auto bg-gray-900 text-white rounded-xl shadow-xl"
          >
            <svg
              className="bg-gray-800 rounded-full p-2.5 pl-3"
              width="40"
              height="40"
              xmlns="http://www.w3.org/2000/svg"
            >
            ...
            <section
              className="grid grid-cols-5 gap-5 md:gap-10 lg:gap-4 2xl:gap-6 text-center mb-8 text-gray-400"
            >
              {rateStarNumber.map((item, key) => {
                return (
                  <button
                    key={key}
                    className="p-1.5 md:p-3 lg:p-2 2xl:p-3.5 bg-gray-800 font-semibold rounded-full hover:bg-orange-500 hover:text-white focus:bg-gray-500 focus:text-white cursor-pointer"
                    onClick={() => {
                      rating_check(item);
                    }}
                  >
            ...
            <button
              className="py-3 font-bold hover:bg-white hover:text-orange-500 bg-orange-500 rounded-full w-full m-auto"
              onClick={() => {
                submit_rating();
              }}
            >
